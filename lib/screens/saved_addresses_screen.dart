...
class _SavedAddressesScreenState extends State<SavedAddressesScreen> {
  ...
  Future<void> _fetchAddresses() async {
    ...
    try {
      ...
      final url = Uri.parse('http://10.0.2.2:8000/api/user/addresses');
  ...
  Future<void> _deleteAddress(int id) async {
    try {
      ...
      final url = Uri.parse('http://10.0.2.2:8000/api/user/addresses/$id');
  ...
  Future<void> _saveAddress({int? id, required Map<String, dynamic> data}) async {
    ...
    try {
      ...
      final url = id == null 
          ? Uri.parse('http://10.0.2.2:8000/api/user/addresses')
          : Uri.parse('http://10.0.2.2:8000/api/user/addresses/$id');
